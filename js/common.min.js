...
!function(){const t=t=>{$(t.currentTarget).addClass("active"),$(".active > .design__descWrap").toggleClass("design__descWrap-show"),$(".active > .design__descWrap  > .design__descItem").toggleClass("design__descItem-active"),$(t.currentTarget).removeClass("active")},s=t=>{t.preventDefault();const s="."+$(t.currentTarget).attr("date-link");let e=$(s).offset().top;const o=$(s).offset().top;$(window).scrollTop()>o&&(e-=$(".navbar").height()),$("html, body").animate({scrollTop:e},"slow")};$(document).ready(()=>{$(".slider").slick({autoplay:!0,prevArrow:'<button type="button" class="slick-prev"><i class="fas fa-angle-left"></i></button>',nextArrow:'<button type="button" class="slick-next"><i class="fas fa-angle-right"></i></button>'}),$(".design__slider").slick({infinite:!0,slidesToShow:3,slidesToScroll:1,prevArrow:'<button type="button" class="slick-prev"><i class="fas fa-angle-left"></i></button>',nextArrow:'<button type="button" class="slick-next"><i class="fas fa-angle-right"></i></button>',responsive:[{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:576,settings:{slidesToShow:1,slidesToScroll:1}}]}),$(".design__sliderItem").click(t),$("[date-link]").click(s),$(window).on("scroll",(()=>{const t=$(".navbar");let s=$(".navbar").offset().top;const e=(s,e)=>{t.css("opacity",`${s}`),t.css("transform",`translateY(${e}%)`)};return()=>{t.offset().top>s&&t.offset().top>t.height()?(e(0,-100),s=t.offset().top):t.offset().top<s&&(e(1,0),s=t.offset().top)}})())})}();