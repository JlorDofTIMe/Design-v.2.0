...
const slickConfig=()=>{$(".slider").slick({autoplay:!0,arrows:!1}),$(".design__slider").slick({infinite:!0,slidesToShow:3,slidesToScroll:1,responsive:[{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:576,settings:{slidesToShow:1,slidesToScroll:1}}]})},showItemDescription=s=>{$(s.currentTarget).addClass("active"),$(".active > .design__descWrap").toggleClass("design__descWrap-show"),$(".active > .design__descWrap  > .design__descItem").toggleClass("design__descItem-active"),$(s.currentTarget).removeClass("active")},scrollToSection=s=>{s.preventDefault();var e="."+$(s.currentTarget).attr("date-link");$("html, body").animate({scrollTop:$(e).offset().top-$(".navbar").height()},"slow")},toggleNavbar=()=>{var s=$(".navbar"),e=$(".navbar").offset().top;return()=>{s.offset().top>e?(s.css("opacity","0"),s.css("transform","translateY(-100%)"),e=s.offset().top):s.offset().top<e&&(s.css("opacity","1"),s.css("transform","translateY(0%)"),e=s.offset().top)}};$(document).ready(()=>{$(".slider").slick({autoplay:!0,arrows:!1}),$(".design__slider").slick({infinite:!0,slidesToShow:3,slidesToScroll:1,responsive:[{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:576,settings:{slidesToShow:1,slidesToScroll:1}}]}),$(".design__sliderItem").click(showItemDescription),$("[date-link]").click(scrollToSection),$(window).on("scroll",toggleNavbar())});